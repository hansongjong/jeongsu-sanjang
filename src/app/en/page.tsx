          ...
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white rounded-xl p-6 shadow-md">
                ...
                <h3 className="font-bold text-lg mb-2">Near Gimpo Airport</h3>
                <p className="text-gray-600 text-sm">Just 20 minutes from Gimpo International Airport. Perfect stop before your flight!</p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-md">
                <span className="text-4xl block mb-3">🏆</span>
                <h3 className="font-bold text-lg mb-2">Authentic Experience</h3>
                <p className="text-gray-600 text-sm">Real Korean food loved by locals. No tourist traps, just genuine flavors.</p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-md">
                <span className="text-4xl block mb-3">🦀</span>
                <h3 className="font-bold text-lg mb-2">Must-Try Dish</h3>
                <p className="text-gray-600 text-sm">Ganjang Gejang is Korea&apos;s most beloved delicacy. Try it here!</p>
              </div>
            </div>
          </div>
        </section>
